...
public class Constants {
	...
	//auto parameter constants
	public final static int AUTO_START_POS_NONE = 0;
	public final static int AUTO_START_POS_LEFT = 1;
	public final static int AUTO_START_POS_MIDDLE = 2;
	public final static int AUTO_START_POS_RIGHT = 3;
	public final static int AUTO_TARGET_TYPE_BASELINE = 2;
	public final static int AUTO_TARGET_TYPE_SWITCH = 0;
	public final static int AUTO_TARGET_TYPE_SCALE = 1;
